...
export const REGISTRY: RegistryEntry[] = [
  ...
  {
    name: "button-group",
    description: "Visually connected group of buttons with shared variant and size",
    templateKey: "ButtonGroup",
    outputFile: "ButtonGroup.tsx",
    internalDeps: ["utils"],
    npmDeps: [],
    target: "components",
  },
  {
    name: "collapsible",
    description: "Simple expand/collapse component for single-section toggling",
    templateKey: "Collapsible",
    outputFile: "Collapsible.tsx",
    internalDeps: ["utils"],
    npmDeps: [],
    target: "components",
  },
  {
    name: "context-menu",
    description: "Right-click menu with nested dropdowns",
    templateKey: "ContextMenu",
    outputFile: "ContextMenu.tsx",
    internalDeps: ["utils"],
    npmDeps: [],
    target: "components",
  },
