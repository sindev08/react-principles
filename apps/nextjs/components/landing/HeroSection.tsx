...
const FloatingLines = dynamic(
  () => import("@react-principles/shared/ui").then((m) => ({ default: m.FloatingLines })),
  { ssr: false },
);
  ...
  return (
    <section className="relative px-6 pt-40 pb-20 overflow-hidden mesh-gradient">
      ...
      <div className="relative z-10 max-w-4xl mx-auto text-center">
        ...
        <h1 className="mb-8 text-5xl font-black leading-[1.1] tracking-tight text-slate-900 dark:text-white md:text-7xl">
          The Living Cookbook <br />
          <span className="text-primary">for Modern React</span>
        </h1>

        <p className="max-w-2xl mx-auto mb-10 text-xl leading-relaxed text-slate-600 dark:text-slate-400">
      ...
      {/* Browser Mockup */}
      <div className="max-w-5xl mx-auto mt-20 overflow-hidden border shadow-2xl rounded-xl border-slate-200 bg-white dark:border-white/10 dark:bg-slate-900">
        <div className="flex items-center h-10 gap-2 px-4 border-b border-slate-200 bg-slate-50 dark:border-white/5 dark:bg-slate-950">
          ...
          <div className="ml-4 flex items-center gap-2 rounded border border-slate-200 dark:border-white/5 bg-white dark:bg-slate-900 px-3 py-1 font-mono text-[10px] text-slate-400 dark:text-slate-500">
            <span className="text-xs material-symbols-outlined">lock</span>
            react-principles.dev/patterns/compound-components
          </div>
        </div>
        <div className="p-8 bg-white dark:bg-slate-900 aspect-video">
          <div className="grid h-full grid-cols-12 gap-8">
            ...
            <div className="col-span-8 p-6 overflow-hidden font-mono text-sm rounded-lg bg-slate-50 dark:bg-slate-950/50 dark:border dark:border-white/5 text-slate-600 dark:text-slate-400">
              <div className="flex items-center gap-2 mb-4 text-primary">
                <span className="text-sm material-symbols-outlined">javascript</span>
                Tabs.tsx
              </div>
              <div className="space-y-2">
                <div className="text-blue-600 dark:text-blue-400">
                  export const{" "}
                  <span className="text-purple-600 dark:text-purple-400">Tabs</span>{" "}
                  = {"({ children }) => {"}
                </div>
