...
import { LOGIN_CODE, SETTINGS_CODE } from "./forms-snippets";
              ...
              <div>
                ...
                <div className="relative">
                  <input
                    readOnly
                    value="invalid_user!"
                    className="w-full pr-10 text-sm rounded-lg border border-red-300 bg-red-50 dark:border-red-900 dark:bg-red-900/10 focus:outline-none px-3 py-2"
                  />
              ...
              <div>
                ...
                <div className="relative">
                  <input
                    ...
                    className="w-full pr-10 text-sm rounded-lg border border-emerald-300 bg-emerald-50 dark:border-emerald-900 dark:bg-emerald-900/10 focus:outline-none px-3 py-2"
                  />
