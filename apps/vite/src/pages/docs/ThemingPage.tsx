...
const TAILWIND_CONFIG = `// tailwind.config.cjs
module.exports = {
  darkMode: "class",
  theme: {
    extend: {
...
const CUSTOM_COLOR = `// tailwind.config.cjs — change primary color
module.exports = {
  theme: {
    extend: {
      colors: {
      ...
      <div className="max-w-3xl">
        ...
        <div className="mb-12">
          ...
          <p className="text-lg leading-relaxed text-slate-600 dark:text-slate-400">
            ...
            are configured in <code className="font-mono text-sm text-primary">tailwind.config.cjs</code> — no CSS variables or runtime tokens.
          </p>
        </div>
        ...
        <section id="colors" className="mb-14">
          ...
          <div className="mt-6">
            <CodeBlock filename="tailwind.config.cjs" copyText={TAILWIND_CONFIG}>
              {TAILWIND_CONFIG}
            </CodeBlock>
          </div>
        </section>
        ...
        <section id="customizing" className="mb-14">
          ...
          <p className="text-slate-600 dark:text-slate-400 mb-6 text-sm leading-relaxed">
            To change the primary color across all components, update the single value in <code className="font-mono text-xs text-primary">tailwind.config.cjs</code>. No CSS variables to hunt down.
          </p>

          <CodeBlock filename="tailwind.config.cjs" copyText={CUSTOM_COLOR}>
            {CUSTOM_COLOR}
          </CodeBlock>

          <div className="mt-6 space-y-3">
            {[
              { label: "Scope", value: "Per-app — each app (nextjs/, vite/) has its own tailwind config file" },
