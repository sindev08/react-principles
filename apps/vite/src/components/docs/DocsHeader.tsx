        ...
        <div className="relative mx-auto flex h-14 max-w-[1440px] items-center justify-between px-6 lg:px-10">
          <div className="flex items-center gap-8">
            ...
            <nav className="hidden items-center gap-6 md:flex">
              <Link to="/" className={navLinkClass(!isDocsActive && !isCookbookActive)}>
                Home
              </Link>
              <Link to="/docs/introduction" className={navLinkClass(isDocsActive)}>
                Docs
              </Link>
              <Link to="/cookbook" className={navLinkClass(isCookbookActive)}>
                Cookbook
              </Link>
            </nav>
          </div>
