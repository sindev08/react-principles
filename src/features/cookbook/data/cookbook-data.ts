...
export const RECIPES: Recipe[] = [
  ...
  },
  {
    ...
    description: "When effects run, why the dependency array exists, and how to clean up after yourself. The mental model React developers get wrong most often.",
    icon: "cycle",
  ...
  },
  {
    ...
    description: "Three categories of state — local, shared, and server — and exactly which tool handles each one. The question you must ask before reaching for any state library.",
    icon: "account_tree",
